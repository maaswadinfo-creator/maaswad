...
import { Gift, Store, Bike, Shield } from 'lucide-react';
...
const ROLE_LINKS: { role: Role; to: string; label: string; icon: any }[] = [
  ...
  { role: 'platform_owner', to: '/admin', label: 'Admin Console', icon: Shield },
  { role: 'operations_manager', to: '/admin', label: 'Admin Console', icon: Shield },
];
